...
/// sharings and the cleartext masked bits required for GGM-tree
/// traversal.
#[derive(Clone, Debug)]
...
impl AuthTensorGen {
    ...
    pub fn prepare_input_labels<R: Rng + CryptoRng>(
        ...
        for i in 0..self.n {
            ...
            self.masked_x_gen.push(input_mac ^ gen_alpha_share_da);
        ...
        for j in 0..self.m {
            ...
            self.masked_y_gen.push(input_mac ^ gen_beta_share_da);
